...
| **Thank You Letters / APR** | Draft | Draft / Edit | **Verify / Sign-off** | Full Access | View / Download |
| **Archive / Drop Student** | -- | Request | **Approve / Move** | Full Access | -- |
| **User Account Mgmt** | -- | -- | -- | Full Access | -- |
...
*   **Verify / Sign-off:** High-level validation role. Content is hidden from the public/sponsor until this role approves it.
...
- **Supervisor:** Quality control and compliance officer; final gatekeeper for official documents.
